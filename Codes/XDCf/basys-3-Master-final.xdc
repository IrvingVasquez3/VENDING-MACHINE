...
#set_property PACKAGE_PIN U16 [get_ports {Dispensar_out}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {Dispensar_out}]
#set_property PACKAGE_PIN E19 [get_ports {Dar_cambio_out}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {Dar_cambio_out}]	
#set_property PACKAGE_PIN N3 [get_ports {CP_OUT}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {CP_OUT}]
#set_property PACKAGE_PIN P3 [get_ports {DP_OUT}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {DP_OUT}]
#set_property PACKAGE_PIN U3 [get_ports {RST_OUT}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {RST_OUT}]	
	
#set_property PACKAGE_PIN V14 [get_ports {UP_OUT}]
